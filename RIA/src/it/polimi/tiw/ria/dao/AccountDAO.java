...
public class AccountDAO extends GeneralDAO {
	...
	public void createAccount(int ownerCode) throws IllegalArgumentException, SQLException {
		/* used variables */
		String query;
		PreparedStatement preparedStatement;
		User user;
		...
		/* main code */
		query = "INSERT INTO Account(Owner,Balance) VALUES (?,0)";
		preparedStatement = conn.prepareStatement(query);
		preparedStatement.setInt(1,ownerCode);
		preparedStatement.executeUpdate();
	}
}
